...
docker run \
		...
		-e "CF_DB_SCHEMA_NAME=$CFG_DB_SCHEMA_NAME" \
		...
		-e "CF_MYSQL_INNODB_PAGE_SIZE=$CF_MYSQL_INNODB_PAGE_SIZE" \
		-e "CF_MYSQL_TABLE_OPEN_CACHE=$CF_MYSQL_TABLE_OPEN_CACHE" \
		-e "CF_MYSQL_TABLE_DEF_CACHE=$CF_MYSQL_TABLE_DEF_CACHE" \
		-e "CF_MYSQL_OPEN_FILES_LIMIT=$CF_MYSQL_OPEN_FILES_LIMIT" \
